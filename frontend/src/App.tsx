...
import { StaffSchedulePage } from "./modules/staff/pages/StaffSchedulePage";
import { StaffAttendancePage } from "./modules/staff/pages/StaffAttendancePage";
import { StaffLeavePage } from "./modules/staff/pages/StaffLeavePage";
import { MyProfilePage } from "./modules/staff/pages/MyProfilePage";
...
import { RoomInventoryPage } from "./modules/rooms/pages/RoomInventoryPage";
...
import { RestaurantInventoryPage } from "./modules/restaurant/pages/RestaurantInventoryPage";
...
import { OccupancyReportPage } from "./modules/reporting/pages/OccupancyReportPage";
import { RestaurantReportPage } from "./modules/reporting/pages/RestaurantReportPage";
import { LiquorReportPage } from "./modules/reporting/pages/LiquorReportPage";
import { LaborReportPage } from "./modules/reporting/pages/LaborReportPage";
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="rooms/inventory" element={<ProtectedRoute roles={["ROOMS"]}><RoomInventoryPage /></ProtectedRoute>} />
        ...
        <Route path="restaurant/inventory" element={<ProtectedRoute roles={["RESTAURANT"]}><RestaurantInventoryPage /></ProtectedRoute>} />
        ...
        <Route path="reporting/occupancy" element={<ProtectedRoute roles={["ROOMS"]}><OccupancyReportPage /></ProtectedRoute>} />
        <Route path="reporting/restaurant" element={<ProtectedRoute roles={["RESTAURANT"]}><RestaurantReportPage /></ProtectedRoute>} />
        <Route path="reporting/liquor" element={<ProtectedRoute roles={["LIQUOR"]}><LiquorReportPage /></ProtectedRoute>} />
        <Route path="reporting/labor" element={<ProtectedRoute roles={["MANAGEMENT"]}><LaborReportPage /></ProtectedRoute>} />

        <Route path="staff" element={<ProtectedRoute roles={["MANAGEMENT"]}><StaffAdminPage /></ProtectedRoute>} />
        <Route path="staff/schedule" element={<ProtectedRoute roles={["MANAGEMENT"]}><StaffSchedulePage /></ProtectedRoute>} />
        <Route path="staff/attendance" element={<ProtectedRoute roles={["MANAGEMENT"]}><StaffAttendancePage /></ProtectedRoute>} />
        <Route path="staff/leave" element={<ProtectedRoute roles={["MANAGEMENT"]}><StaffLeavePage /></ProtectedRoute>} />
        <Route path="staff/:id" element={<ProtectedRoute roles={["MANAGEMENT"]}><StaffDetailPage /></ProtectedRoute>} />
